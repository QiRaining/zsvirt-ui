...
@Injectable()
export class SNSDingTalkAtPersonQueryService {
  ...
  async queryList(param: IQueryAction) {
    ...
    _resultResp = await this.getSNSDingTalkAtPersons(param, zqlCondition)
  ...
  async getSNSDingTalkAtPersons(param: IQueryAction, zqlCondition: ZqlObject['condition']) {
    const zqlObject = {
