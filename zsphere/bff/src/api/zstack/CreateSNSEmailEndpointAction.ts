...
@Injectable()
export class CreateSNSEmailEndpointAction extends ActionAdvance {
  async call(
    params: CreateSNSEmailEndpointActionParam,
    _info: ActionInfo = {},
    needRecord = true,
    ...
    const { actionId, sessionId, apiId, apiRecord } = await this.preAction(
      _info,
      needRecord,
      CreateSNSEmailEndpointAction.name,
      params,
    );
    const httpRequestPromise = this.zsHttpService.post(
      `/sns/application-endpoints/emails`,
      {
        params: params,
