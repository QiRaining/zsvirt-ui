...
@Injectable()
export class AddAliyunNasPrimaryStorageAction extends ActionAdvance {
  async call(
    params: AddAliyunNasPrimaryStorageActionParam,
    _info: ActionInfo = {},
    needRecord = true,
    ...
    const { actionId, sessionId, apiId, apiRecord } = await this.preAction(
      _info,
      needRecord,
      AddAliyunNasPrimaryStorageAction.name,
      params,
    );
    const httpRequestPromise = this.zsHttpService.post(
      `/primary-storage/aliyun/nas`,
      {
        params: params,
