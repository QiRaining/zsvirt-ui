...
@Injectable()
export class AddSharedMountPointPrimaryStorageAction extends ActionAdvance {
  async call(
    params: AddSharedMountPointPrimaryStorageActionParam,
    _info: ActionInfo = {},
    needRecord = true,
    ...
    const { actionId, sessionId, apiId, apiRecord } = await this.preAction(
      _info,
      needRecord,
      AddSharedMountPointPrimaryStorageAction.name,
      params,
    );
