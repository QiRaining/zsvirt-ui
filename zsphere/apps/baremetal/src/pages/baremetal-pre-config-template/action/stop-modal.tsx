  ...
  const onOk = async () => {
    ...
    doAction({
      ...
      name: intl.formatMessage({
        id: "disable.preConfigurationTemplate",
        defaultMessage: "Disable Bare Metal Template",
      }),
  ...
  return (
    <DialogP3
      ...
      title={intl.formatMessage({
        id: "preConfigurationTemplate.modal.title.confirm.disable.preConfigurationTemplate",
        defaultMessage: "Disable Bare Metal Template?",
      })}
