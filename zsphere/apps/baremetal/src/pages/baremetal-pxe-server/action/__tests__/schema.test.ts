...
import { createBaremetalPxeServerUpdateSchema } from "../schema";

const intl = createMockIntl();

describe("createBaremetalPxeServerUpdateSchema", () => {
  const schema = createBaremetalPxeServerUpdateSchema(intl);
