...
import { getMicrosoftTeamsTemplate } from "../../util";
...
const MicrosoftTeamsContent: React.FC<IProps> = ({
  isResourceAlarm,
  formInstance,
  init,
}) => {
    ...
    if (init) {
      ...
      formInstance.setFieldsValue({
        zwatchSNSTextTemplate: {
          microsoftTeams: {
            ...microsoftTeams,
            template: getMicrosoftTeamsTemplate(microsoftTeams.template),
            recoveryTemplate: getMicrosoftTeamsTemplate(
              microsoftTeams.recoveryTemplate,
            ),
          },
        },
      });
  ...
  }, [formInstance, init, isResourceAlarm]);
  ...
  return (
    <>
      <Item
        ...
        required
        name={["zwatchSNSTextTemplate", "microsoftTeams", "subject"]}
        icon="info"
        iconTooltip={
          <ReactMarkdown>
            {intl.formatMessage({
...
When an alarm is triggered, the platform sends alarm messages to the selected endpoint. You can customize the text content of the alarm messages as needed.`,
        ...
        name={["zwatchSNSTextTemplate", "microsoftTeams", "template"]}
...
export default MicrosoftTeamsContent;
