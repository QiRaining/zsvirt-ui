...
const deleteDatabaseBackupDataList = gql`
  mutation deleteDatabaseBackupDataList(
    $input: DeleteDatabaseBackupDataListInput!
  ) {
    deleteDatabaseBackupDataList(input: $input) {
      actionId
    }
  }
`;

const Action: React.FC<IActionWrapperProps<BackupDatabase>> = ({
  view,
  visible,
  setVisible,
  selectedList,
  ...
  const onOk = async () => {
    ...
    doAction({
      ...
      name: intl.formatMessage({
        id: "delete.dataBase.back.data",
        defaultMessage: "Delete Platform Database Backup Data",
      }),
