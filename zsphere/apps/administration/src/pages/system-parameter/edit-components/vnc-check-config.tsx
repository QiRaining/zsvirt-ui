...
const VNCCheckConfig: React.FC<IProps> = ({
  visible,
  setVisible,
  currItem,
  ok,
    ...
    () =>
      createPasswordRangeSchema(intl, {
        ...
        minimumTooSmallMessage: {
          id: "cannot.be.less.than.six",
          defaultMessage: "Enter an integer no smaller than 6.",
        },
        maximumTooLargeMessage: {
          id: "cannot.be.greater.than.eight",
          defaultMessage: "The value cannot be greater than 8.",
        },
        requireInteger: true,
      }),
    [intl],
