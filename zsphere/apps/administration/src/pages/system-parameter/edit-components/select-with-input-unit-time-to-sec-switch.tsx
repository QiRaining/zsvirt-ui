...
const SelectWithInputUnitTimeToSecoundSwitch: React.FC<IProps> = ({
  visible,
  setVisible,
  currItem,
  ok,
  ...
  const defaultValues = useMemo<DynamicGlobalConfigFormValues>(
    () => ({
      [settingName]: currItem?.formItem?.value === "0" ? "0" : "-",
      [valueName]: {
        number: undefined,
...
export default SelectWithInputUnitTimeToSecoundSwitch;
