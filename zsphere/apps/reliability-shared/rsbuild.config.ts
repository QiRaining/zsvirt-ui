...
const APP_NAME = "zsv-reliability-shared";
...
export default defineConfig({
  plugins: [
    ...
    pluginModuleFederation({
      ...
      exposes: {
        "./vm-scheduling-rule/vm-group/mf-index":
          "./src/domain/vm-scheduling-rule/mf-index",
        "./vm-scheduling-rule/vm-group/utils":
          "./src/domain/vm-scheduling-rule/vm-group/utils",
        "./vm-scheduling-rule/context":
          "./src/domain/vm-scheduling-rule/context.ts",
      },
      dts: false,
    }),
  ],
