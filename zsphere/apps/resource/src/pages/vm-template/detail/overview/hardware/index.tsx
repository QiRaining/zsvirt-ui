import { useTpmList } from "@zstack/virtualization-resource/src/pages/vm/detail/overview/hardware/use-tpm-list";
...
const VmHardware: React.FC<IProps> = ({
  ...
  const otherDeviceList = useOtherDeviceList(resourceConfig, detail);
  ...
  useActionSubscribe({
    ...
    onFinish: () => {
      ...
      refetchCdrom();
      refetchPcie();
      // refetchTpm is not needed as tpmList is derived from detail prop
    },
  });
