...
// import SelectVm from '@zstack/virtualization-data-protection/src/pages/backup-management/backup-policy/action/components/SelectVm'
// import { priorityValueMap } from '@zstack/virtualization-data-protection/src/pages/backup-management/backup-policy/action/create'
...
export default function AttachVm({
  ...
  return (
    ...
    >
      <Form form={form}>{/* <SelectVm zoneUuid={source?.zoneUuid} /> */}</Form>
    </DialogForm>
  );
}
