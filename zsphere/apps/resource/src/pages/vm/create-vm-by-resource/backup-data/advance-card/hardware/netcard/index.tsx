    ...
    <div className={styles.content}>
      <Item
        ...
        shouldUpdate={(pre, cur) => {
          const l3networkKeys = _.keys(pre).filter(
            (key) =>
        ...
        {() => {
          ...
          if (isRunPathTouched && l3.length !== 0) {
            ...
            if (
              ...
              clusterUuid = runPath?.[0]?.clusterUuid;
            }
          ...
          const l3NetworkUuids = _.keys(values)
            .filter(
              (key) =>
