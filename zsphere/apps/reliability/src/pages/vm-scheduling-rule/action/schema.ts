...
const vmSchedulingRuleNameString = (intl: IntlLike) =>
  requiredString(intl)
...
export const createUpdateVmSchedulingRuleSchema = (intl: IntlLike) =>
  z.object({
    name: vmSchedulingRuleNameString(intl),
    description: commonDescriptionString(intl),
  });

export type UpdateVmSchedulingRuleFormValues = z.infer<
  ReturnType<typeof createUpdateVmSchedulingRuleSchema>
>;
