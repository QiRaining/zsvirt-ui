...
const hostGroupNameString = (intl: IntlLike) =>
  requiredString(intl)
...
export const createUpdateHostGroupSchema = (intl: IntlLike) =>
  z.object({
    name: hostGroupNameString(intl),
    description: commonDescriptionString(intl),
  });

export type UpdateHostGroupFormValues = z.infer<
  ReturnType<typeof createUpdateHostGroupSchema>
>;
