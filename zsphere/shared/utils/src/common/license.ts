...
export const translateLicenseModuleName = (
  ...
  const map: {
    ...
    [LicenseDescType.ZStoneRBD]: intl.formatMessage({
      id: "about.module.name.zstone",
      defaultMessage: "Distributed Storage",
    }),
    [LicenseDescType.ZStoneRGW]: intl.formatMessage({
      id: "about.module.name.zstone",
      defaultMessage: "Distributed Storage",
    }),
    [LicenseDescType.ZStoneProd]: intl.formatMessage({
      id: "about.module.name.zstone",
      defaultMessage: "Distributed Storage",
    }),
    [LicenseDescType.SecurityElementUi]: intl.formatMessage({
...
export const translateLicenseType = (
  ...
  if (prodInfo === ProdInfo.EnterpriseXinChuangCloud) {
