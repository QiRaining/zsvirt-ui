...
type IKey = 'name' | 'uuid' | 'vCenter' | 'backupStorage' | 'owner'
...
const useQueryConfig = (
  ...
  const remoteConfig = useRemoteConfig('vcenter-image')
  ...
  const originCandidates = useMemo(() => {
    const list: ICandidate[] = [
      ...
      {
        label: intl.formatMessage({ id: 'backupStorage', defaultMessage: 'Image Storage' }),
        key: 'backupStorage',
        type: 'input'
      },
      {
