...
type IKey = 'name' | 'uuid' | 'state' | 'owner' | 'shareType' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main': ['name', 'state', 'owner', 'shareType', 'createDate'],
      'main.share': ['name', 'state', 'owner', 'shareType', 'createDate'],
      'select': ['name', 'state', 'owner', 'shareType', 'createDate'],
      'sub': ['name', 'state', 'owner', 'shareType', 'createDate'],
