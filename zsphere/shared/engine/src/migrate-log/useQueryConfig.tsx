...
type IKey = 'vmName' | 'preHost' | 'targetHost'
...
const useQueryConfig = (
  ...
  const remoteConfig = useRemoteConfig('migrate-log')
  ...
  const originCandidates = useMemo(() => {
    const list: ICandidate[] = [
      {
        label: intl.formatMessage({ id: 'vm.name', defaultMessage: 'VM Name' }),
        key: 'vmName',
        type: 'input'
      },
      {
        label: intl.formatMessage({ id: 'pre.host', defaultMessage: 'Pre Host' }),
        key: 'preHost',
        type: 'input'
      },
      {
        label: intl.formatMessage({ id: 'target.host', defaultMessage: 'Destination Host' }),
        key: 'targetHost',
        type: 'input'
      },
    ]
