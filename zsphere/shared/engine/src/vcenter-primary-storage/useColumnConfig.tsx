...
type IKey = 'name' | 'uuid' | 'type' | 'url' | 'availableCapacity' | 'availablePhysicalCapacity' | 'totalCapacity' | 'state' | 'status' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'sub.vCenter': ['name', 'type', 'url', 'availableCapacity', 'availablePhysicalCapacity', 'totalCapacity', 'state', 'status'],
    }
  }), [intl, getServerTime])
