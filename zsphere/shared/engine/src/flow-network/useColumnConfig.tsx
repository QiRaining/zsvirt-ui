...
type IKey = 'name' | 'uuid' | 'networkType' | 'hypervisorType' | 'avaliableCapacity' | 'cidr' | 'ipv4Cidr' | 'ipv6Cidr' | 'toPublic' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main.flow': ['name', 'avaliableCapacity', 'ipv4Cidr', 'createDate'],
      'select.flow': ['name', 'avaliableCapacity', 'ipv4Cidr', 'createDate'],
      'sub.flow': ['name', 'avaliableCapacity', 'ipv4Cidr', 'createDate'],
    }
  }), [intl, getServerTime])
