...
type IKey = 'name' | 'uuid' | 'networkType' | 'hypervisorType' | 'avaliableCapacity' | 'cidr' | 'ipv4Cidr' | 'ipv6Cidr' | 'ip.allocation.strategy' | 'dhcp.service' | 'toPublic' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main.public': ['name', 'avaliableCapacity', 'ipv4Cidr', 'ipv6Cidr', 'toPublic', 'createDate'],
      'main.public.share': ['name', 'avaliableCapacity', 'ipv4Cidr', 'ipv6Cidr', 'toPublic', 'createDate'],
      'select.public': ['name', 'avaliableCapacity', 'ipv4Cidr', 'ipv6Cidr', 'ip.allocation.strategy', 'dhcp.service', 'toPublic', 'createDate'],
