...
type IKey = 'name' | 'uuid' | 'zone' | 'type' | 'url' | 'availableCapacity' | 'totalCapacity' | 'usedCapacity' | 'state' | 'status' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main': ['name', 'type', 'url', 'usedCapacity', 'state', 'status', 'createDate'],
      'select': ['name', 'type', 'url', 'usedCapacity', 'createDate'],
      'sub.alarm': ['name', 'type', 'availableCapacity', 'totalCapacity', 'status', 'createDate'],
      'sub.virutalization.alarm': ['name', 'type', 'url', 'usedCapacity', 'state', 'status', 'createDate'],
      'sub.virutalization.zone': ['name', 'type', 'url', 'usedCapacity', 'state', 'status', 'createDate'],
    }
  }), [intl, getServerTime])
