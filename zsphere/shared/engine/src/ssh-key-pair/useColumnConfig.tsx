...
type IKey = 'name' | 'description' | 'uuid' | 'tag' | 'vmNum' | 'owner' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'number.of.bound.vm', defaultMessage: 'Associated VMs' }),
        i18nKey: 'number.of.bound.vm',
        key: 'vmNum',
        width: 100,
        render: (value:any) => {
          const renderText = (value: any) => {
    ...
    viewMap: {
      'main': ['name', 'tag', 'vmNum', 'owner', 'createDate'],
      'select': ['name', 'tag', 'vmNum', 'owner', 'createDate'],
      'sub.create': ['name', 'tag', 'vmNum', 'owner', 'createDate'],
    }
  }), [intl, getServerTime])
