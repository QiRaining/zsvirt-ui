...
type IKey = 'name' | 'uuid' | 'wwid' | 'vendor' | 'model' | 'wwn' | 'hctl' | 'type' | 'size' | 'vm-instance.count' | 'source' | 'path' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      ...
      'select': [],
      'sub': [],
      'sub.iqn': ['name', 'wwid', 'vendor', 'model', 'wwn', 'hctl', 'type', 'size', 'path'],
      'sub.virtualization.iqn': ['name', 'wwid', 'vendor', 'model', 'wwn', 'hctl', 'type', 'size', 'path'],
    }
  }), [intl, getServerTime])
