...
type IKey = 'name' | 'uuid' | 'type' | 'url' | 'state' | 'owner' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'endpointType', defaultMessage: 'Type' }),
        i18nKey: 'endpointType',
        key: 'type',
        width: 140,
        render: (value: any) => {
          const renderText = (value: any) => {
      ...
      {
        title: intl.formatMessage({ id: 'endpointAddress', defaultMessage: 'Address' }),
        i18nKey: 'endpointAddress',
        key: 'url',
        width: 200,
        render: (value:any) => {
          const renderText = (value: any) => {
    ...
    viewMap: {
      'main': ['name', 'type', 'url', 'state', 'owner', 'createDate'],
      'main.virtualization': ['name', 'type', 'url', 'state', 'owner', 'createDate'],
      'select.virtualization': ['name', 'type', 'url', 'state', 'owner', 'createDate'],
      'sub': ['name', 'type', 'url', 'state', 'owner', 'createDate'],
      'sub.virtualization': ['name', 'type', 'url', 'state', 'owner', 'createDate'],
      'sub.virtualization.event': ['name', 'type', 'url', 'state', 'owner', 'createDate'],
      'sub.virtualization.resource': ['name', 'type', 'url', 'state', 'owner', 'createDate'],
    }
  }), [intl, getServerTime])
