...
type IKey = 'name' | 'uuid' | 'nic' | 'ipCapacity' | 'cidr' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'ip.usage', defaultMessage: 'IP Utilization' }),
        i18nKey: 'ip.usage',
        key: 'ipCapacity',
        width: 140,
        render: (value:any) => {
    ...
    viewMap: {
      'main': ['name', 'nic', 'ipCapacity', 'cidr', 'createDate'],
      'select': ['name', 'nic', 'ipCapacity', 'cidr', 'createDate'],
      'select.elastic.baremetal.cluster.create': ['name', 'nic', 'ipCapacity', 'cidr', 'createDate'],
    }
  }), [intl, getServerTime])
