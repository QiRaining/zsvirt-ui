...
type IKey = 'uuid' | 'name' | 'ip' | 'strategy' | 'createDate' | '__action__'
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      },
      {
        ...
        render: (value:any) => {
          const renderText = (value: any) => {
            const val = formatValue('strategy', value, options)
            return val || val === 0 ? <Text>{ val }</Text> : null
          }
          const renderExtra = getOption('strategy', options)?.extra
          if (renderExtra) {
            return (
              <div className="flex flex-nowrap gap-2">
                <div className="min-w-0 flex-auto">
    ...
    viewMap: {
      'main': ['name', 'ip', 'createDate'],
      'main.virtualization': ['name', 'ip', 'strategy', 'createDate'],
      'sub.virtualization': ['name', 'ip', 'strategy', 'createDate'],
    }
  }), [intl, getServerTime])
