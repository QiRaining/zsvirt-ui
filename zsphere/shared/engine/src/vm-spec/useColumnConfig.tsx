...
type IKey = 'uuid' | 'name' | 'platform' | 'description' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'vm.spec.platform', defaultMessage: 'Target VM OS' }),
        i18nKey: 'vm.spec.platform',
        key: 'platform',
        width: 200,filters: [],
        render: (value: any) => {
          const renderText = (value: any) => {
    ...
    viewMap: {
      'main': ['name', 'platform', 'description', 'createDate'],
      'select': ['name', 'platform', 'description', 'createDate'],
    }
  }), [intl, getServerTime])
