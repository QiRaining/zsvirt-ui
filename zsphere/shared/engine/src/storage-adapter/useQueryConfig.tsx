...
type IKey = 'name' | 'model' | 'identifier'
...
const useQueryConfig = (
  ...
  const remoteConfig = useRemoteConfig('storage-adapter')
  ...
  const originCandidates = useMemo(() => {
    const list: ICandidate[] = [
      ...
      {
        label: intl.formatMessage({ id: 'storage.adapter.identifier', defaultMessage: 'Identifier' }),
        key: 'identifier',
        type: 'input'
      },
    ]
