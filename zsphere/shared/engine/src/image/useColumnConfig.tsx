...
type IKey = 'name' | 'platform' | 'guestOsType' | 'state' | 'status' | 'shareType' | 'size' | 'architecture' | 'mediaType' | 'format' | 'backupStorage' | 'baremetal2Image' | 'zone' | 'uuid' | 'owner' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'support.baremetal2Image', defaultMessage: 'Support Elastic Baremetal' }),
        i18nKey: 'support.baremetal2Image',
        key: 'baremetal2Image',
        width: 140,filters: [],
        render: (value:any) => {
          const renderText = (value: any) => {
            const val = formatValue('baremetal2Image', value, options)
            return val || val === 0 ? <Text>{ val }</Text> : null
          }
          const renderExtra = getOption('baremetal2Image', options)?.extra
          if (renderExtra) {
            return (
              <div className="flex flex-nowrap gap-2">
                <div className="min-w-0 flex-auto">
    ...
    viewMap: {
      'main': ['name', 'platform', 'guestOsType', 'state', 'status', 'shareType', 'size', 'architecture', 'mediaType', 'format', 'backupStorage', 'owner', 'createDate'],
      'select': ['name', 'status', 'size', 'mediaType', 'format', 'backupStorage', 'owner', 'createDate'],
      'select.virtualization': ['name', 'status', 'size', 'mediaType', 'owner', 'createDate'],
      'select.virtualization.cdrom': ['name', 'status', 'size', 'mediaType', 'owner', 'createDate'],
      'select.virtualization.diskimage': ['name', 'status', 'size', 'mediaType', 'format', 'owner', 'createDate'],
      'sub': ['name', 'platform', 'guestOsType', 'state', 'status', 'size', 'mediaType', 'format', 'backupStorage', 'owner', 'createDate'],
      'sub.virtualization.account.shared': ['name', 'status', 'size', 'mediaType', 'format', 'owner', 'createDate'],
      'sub.virtualization.backup-storage': ['name', 'status', 'shareType', 'size', 'mediaType', 'format', 'owner', 'createDate'],
      'sub.virtualization.backup-storage.detail.exported': ['name', 'shareType', 'size', 'mediaType', 'createDate'],
      'sub.virtualization.zone': ['name', 'shareType', 'size', 'mediaType', 'uuid', 'owner', 'createDate'],
      'sub.virtualization.zone.detail.exported': ['name', 'shareType', 'size', 'mediaType', 'format', 'backupStorage', 'zone', 'uuid', 'createDate'],
      'sub.virtualization.zone.recyle': ['name', 'shareType', 'size', 'mediaType', 'format', 'zone', 'owner', 'createDate'],
