...
type IKey = 'name' | 'uuid' | 'vpcVRouter' | 'owner' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main': ['name', 'vpcVRouter', 'owner', 'createDate'],
      'select': ['name', 'vpcVRouter', 'owner', 'createDate'],
      'sub': ['name', 'vpcVRouter', 'owner', 'createDate'],
    }
  }), [intl, getServerTime])
