...
const useQueryConfig = (
  ...
  const remoteConfig = useRemoteConfig('dynamic-resource-ispatch-strategy')
  ...
  const originCandidates = useMemo(() => {
    const list: ICandidate[] = [
      {
        label: intl.formatMessage({ id: 'cluster.name', defaultMessage: 'Cluster Name' }),
        key: 'cluster.name',
        type: 'input'
      },
    ]
