...
type IKey = 'name' | 'uuid' | 'platform' | 'state' | 'topicNum' | 'owner' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'messageSource', defaultMessage: 'Message Source' }),
        i18nKey: 'messageSource',
        key: 'platform',
        width: 200,
        render: (value:any) => {
          const renderText = (value: any) => {
    ...
    viewMap: {
      'main': ['name', 'platform', 'state', 'topicNum', 'owner', 'createDate'],
      'select': ['name', 'platform', 'state', 'topicNum', 'owner', 'createDate'],
      'sub': ['name', 'platform', 'state', 'topicNum', 'owner', 'createDate'],
    }
  }), [intl, getServerTime])
