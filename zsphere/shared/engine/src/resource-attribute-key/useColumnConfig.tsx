...
type IKey = 'uuid' | 'name' | 'resourceType' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'resource.attribute.key', defaultMessage: 'Attribute Key' }),
        i18nKey: 'resource.attribute.key',
        key: 'name',
    ...
    viewMap: {
      'main': ['name', 'resourceType', 'createDate'],
    }
  }), [intl, getServerTime])
