...
const useQueryConfig = (
  ...
  const remoteConfig = useRemoteConfig('system-scheduling-task')
  ...
  const originCandidates = useMemo(() => {
    const list: ICandidate[] = [
      {
        label: intl.formatMessage({ id: 'operating.resources', defaultMessage: 'Operated Resource' }),
        key: 'operatingResources',
        type: 'input'
      },
    ]
    if (filteredKeys) {
