...
type IKey = 'name' | 'uuid' | 'vendor' | 'model' | 'wwn' | 'size' | 'wwid' | 'source' | 'type' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main': ['name', 'vendor', 'model', 'wwn', 'size', 'wwid', 'source', 'type'],
      'sub.host': ['name', 'vendor', 'model', 'wwn', 'size', 'wwid', 'source', 'type'],
      'sub.nvme.target': ['name', 'vendor', 'model', 'wwn', 'size', 'wwid', 'type'],
      'sub.storage.adapter': ['name', 'vendor', 'model', 'wwn', 'size', 'wwid', 'source', 'type'],
    }
  }), [intl, getServerTime])
