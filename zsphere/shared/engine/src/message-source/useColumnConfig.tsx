...
type IKey = 'name' | 'uuid' | 'type' | 'state' | 'owner' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main': ['name', 'type', 'state', 'owner', 'createDate'],
      'select': ['name', 'type', 'state', 'owner', 'createDate'],
      'sub': ['name', 'type', 'state', 'owner', 'createDate'],
    }
  }), [intl, getServerTime])
