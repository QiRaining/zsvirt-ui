...
type IKey = 'name' | 'uuid' | 'state' | 'owner' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main': ['name', 'state', 'owner', 'createDate'],
      'select': ['name', 'state', 'owner', 'createDate'],
      'sub': ['name', 'state', 'createDate'],
      'sub.iam2Project': ['name', 'state', 'owner', 'createDate'],
      'sub.virtualization.zone': ['name', 'state', 'owner', 'createDate'],
    }
  }), [intl, getServerTime])
