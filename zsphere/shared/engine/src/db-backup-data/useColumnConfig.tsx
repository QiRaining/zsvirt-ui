...
type IKey = 'name' | 'version' | 'createDate' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    list: [
      ...
      {
        title: intl.formatMessage({ id: 'virtualization.version', defaultMessage: 'Version' }),
        i18nKey: 'virtualization.version',
        key: 'version',
        width: 100,
        render: (value:any) => {
          const renderText = (value: any) => {
    ...
    viewMap: {
      'select.wizard': ['name', 'version', 'createDate'],
      'virtualization.main': [],
    }
  }), [intl, getServerTime])
