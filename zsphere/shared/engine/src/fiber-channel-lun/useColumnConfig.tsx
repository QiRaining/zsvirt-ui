...
type IKey = 'name' | 'uuid' | 'vendor' | 'model' | 'wwn' | 'size' | 'wwid' | 'vm-instance.count' | 'type' | 'source' | '__action__'
...
function useColumnConfig<T extends Item>(
  ...
  const _columnConfig: ITableListProps<T>['columnConfig'] = useMemo(() => ({
    ...
    viewMap: {
      'main': ['name', 'vendor', 'model', 'wwn', 'size', 'wwid', 'vm-instance.count', 'type', 'source'],
      'main.nvme': ['name', 'vendor', 'model', 'wwn', 'size', 'wwid', 'vm-instance.count', 'type', 'source'],
      'select': [],
      'sub': [],
      'sub.fiber-channel-storage': ['name', 'wwn', 'size', 'wwid', 'vm-instance.count', 'type', 'source'],
    }
  }), [intl, getServerTime])
