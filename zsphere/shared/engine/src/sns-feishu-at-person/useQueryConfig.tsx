...
const useQueryConfig = (
  ...
  const remoteConfig = useRemoteConfig('sns-feishu-at-person')
  ...
  const originCandidates = useMemo(() => {
    const list: ICandidate[] = [
      {
        label: intl.formatMessage({ id: 'userId', defaultMessage: 'User ID' }),
        key: 'userId',
        type: 'input'
      },
      {
        label: intl.formatMessage({ id: 'remarks', defaultMessage: 'Remark' }),
        key: 'remark',
        type: 'input'
      },
    ]
